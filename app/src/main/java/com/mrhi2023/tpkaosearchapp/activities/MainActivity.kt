...
import com.mrhi2023.tpkaosearchapp.databinding.ActivityMainBinding
...
import com.mrhi2023.tpkaosearchapp.network.RetrofitApiService
import com.mrhi2023.tpkaosearchapp.network.RetrofitHelper
...
class MainActivity : AppCompatActivity() {
    ...
    val permissionLauncher: ActivityResultLauncher<String> = registerForActivityResult(ActivityResultContracts.RequestPermission(), object : ActivityResultCallback<Boolean>{
        override fun onActivityResult(result: Boolean?) {
            ...
            else Toast.makeText(this@MainActivity, "위치정보제공에 동의하지 않았습니다. 검색기능이 제한됩니다.", Toast.LENGTH_SHORT).show()
        }
    })
    ...
    private fun clickChoice(view: View){
        ...
        when(choiceID){
            ...
            R.id.choice1-> searchQuery= "버스정류소"
            R.id.choice2-> searchQuery= "버스정류소"
            R.id.choice3-> searchQuery= "버스정류소"
            R.id.choice4-> searchQuery= "버스정류소"
            R.id.choice5-> searchQuery= "버스정류소"
        }
